...
swiftc -target arm64-apple-macosx13.0 \
  "$ROOT/Tests/InstalledAppIntegrationTests.swift" -I "$BUILD" -L "$BUILD" -lWeBoxCore \
  -Xlinker -rpath -Xlinker @executable_path \
  -o "$BUILD/WeBoxInstalledAppIntegrationTests"
"$BUILD/WeBoxInstalledAppIntegrationTests"
